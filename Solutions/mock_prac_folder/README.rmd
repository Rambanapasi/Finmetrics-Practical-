...
- the optimizer is not giving me what I want. still allocates heavily to FI and credit. I suspect that its because the covarainace matrix is constructed on historical asset returns. I dont know how to add forcasts such as the Black-Litterman for the mean returns matrix. 
